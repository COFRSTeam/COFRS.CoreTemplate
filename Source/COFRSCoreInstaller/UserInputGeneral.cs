...
namespace COFRSCoreInstaller
{
	public partial class UserInputGeneral : Form
	{
		...
		private void OnLoad(object sender, EventArgs e)
		{
			...
			foreach (var resourceFile in resourceClasses)
				_resourceModelList.Items.Add(resourceFile);
