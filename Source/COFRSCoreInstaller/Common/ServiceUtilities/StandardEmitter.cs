...
namespace COFRS.Template.Common.ServiceUtilities
{
	public class StandardEmitter
	{
		...
		public string EmitMappingModel(ResourceModel resourceModel, EntityModel entityModel, ProfileMap profileMap, string mappingClassName, Dictionary<string, string> replacementsDictionary)
		{
			...
			results.AppendLine("\t//\tIf you edit this file manually, COFRS will be unable to generate the");
			results.AppendLine("\t//\tcooresponding validators and sample objects for you.");
			results.AppendLine("\t//");
			results.AppendLine("\t//\tUse the context menu \"Edit Mapping...\" command to edit this class.");
			results.AppendLine("\t//=============================================================================");
			results.AppendLine();
